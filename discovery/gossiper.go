...
type AuthenticatedGossiper struct {
	...
	// syncManager is a subsystem responsible for managing the gossip
	// syncers for peers currently connected. When a new peer is connected,
	// the manager will create its accompanying gossip syncer and determine
...
func New(cfg Config, selfKey *btcec.PublicKey) *AuthenticatedGossiper {
	gossiper := &AuthenticatedGossiper{
		...
		syncMgr: newSyncManager(&syncManagerCfg{
			...
			FullSyncTicker:            cfg.FullSyncTicker,
