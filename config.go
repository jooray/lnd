...
type config struct {
	...
	GraphUpdatePeers int `long:"graphupdatepeers" description:"The number of peers that we should receive new graph updates from. This option can be tuned to save bandwidth for light clients or routing nodes."`
...
func loadConfig() (*config, error) {
	defaultCfg := config{
		...
		GraphUpdatePeers:         defaultMinPeers,
		Tor: &torConfig{
